...
import fr.bofgames.repository.CartRepository;
import fr.bofgames.repository.search.CartSearchRepository;
...
public class CartResourceIT {
     ...
     *
     * @see fr.bofgames.repository.search.CartSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createCart() throws Exception {
        ...
        assertThat(testCart.getExpiration()).isEqualTo(DEFAULT_EXPIRATION);
    ...
    public void updateCart() throws Exception {
        ...
        Cart testCart = cartList.get(cartList.size() - 1);
        assertThat(testCart.getExpiration()).isEqualTo(UPDATED_EXPIRATION);
