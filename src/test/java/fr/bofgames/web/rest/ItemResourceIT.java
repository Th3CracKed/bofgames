...
public class ItemResourceIT {
     ...
     *
     * @see fr.bofgames.repository.search.ItemSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllItemsWithEagerRelationshipsIsEnabled() throws Exception {
        ItemResource itemResource = new ItemResource(itemRepositoryMock, mockItemSearchRepository);
