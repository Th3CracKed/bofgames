...
import fr.bofgames.repository.ReviewRepository;
import fr.bofgames.repository.search.ReviewSearchRepository;
...
public class ReviewResourceIT {
     ...
     *
     * @see fr.bofgames.repository.search.ReviewSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchReview() throws Exception {
        // Initialize the database
        reviewRepository.saveAndFlush(review);
        when(mockReviewSearchRepository.search(queryStringQuery("id:" + review.getId())))
