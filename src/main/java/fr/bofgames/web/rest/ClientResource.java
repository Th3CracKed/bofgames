...
import fr.bofgames.repository.ClientRepository;
import fr.bofgames.repository.search.ClientSearchRepository;
...
/**
 * REST controller for managing {@link fr.bofgames.domain.Client}.
 */
@RestController
@RequestMapping("/api")
